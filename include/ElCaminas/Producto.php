...
class Producto
{
    ...
    public function getHtml(){
      ...
      $str .= "<a href='./carro.php?action=add&id=" . $this->id . "&cantidad=".$this->cantidad."&redirect=".$this->getUrl()."' class='btn btn-danger' style='position:absolute; bottom:4px; right:4px'>Comprar</a>";
    ...
    public function getHtmlPopup(){
      ...
      $str .= "<h2 class='subtitle text-center col-xs-12' style='margin:0'>" . $this->nombre ."</h2>";
      $str .= "<img class='center-block img-responsive img-thumbnail col-xs-12' src='./basededatos/img/600_" . $this->foto . "' alt=''>";
    	$str .= "<div class='caption col-xs-12'>";
    	$str .= "<p class='text-center h4 text-success'>" . $this->descripcion . "</p>";
    	$str .= "</div>";
      $str .= "</div>";
    ...
    public function getThumbnailHtml(){
      ...
      $str = "<div class='col-sm-4 col-lg-4 col-md-4'>";
        $str .= "<div class='thumbnail' style='position:relative'>";
          ...
          $str .= "<div class='caption'>";
            $str .= "<h4><a href='" .  $this->url . "'>". $this->nombre . "</a><a class='open-modal' title='Haga click para más información' href='".$this->getUrl()."'><span style='margin-left:10px; color:#000' class='fa fa-external-link'></sapan></a></h4>";
            $str .= "<p>". $this->descripcion . "</p>";
          $str .= "</div>";
          $str .= "<h4 class='pull-right'>" . $this->getHtmlPrecio() . "</h4>";
          $str .= "<a href='./carro.php?action=add&id=" . $this->id . "&cantidad=".$this->cantidad."&redirect=".$_SERVER['REQUEST_URI']."' class='btn btn-danger'>Comprar</a>";
        $str .= "</div>";
      $str .= "</div>";
      return $str;
