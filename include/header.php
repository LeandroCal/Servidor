    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        <div class="container">
            ...
            <div class="navbar-header col-xs-12 col-md-6">
                ...
                <a class="navbar-brand" href="./index.php">Smartphones El Caminás</a>
                <div id="carrito">
                  <a href="carro.php"><span class="fa fa-shopping-cart" aria-hidden="true"></span><p class="badge"><?php echo $carrito->howMany()?> productos</p></a>
                </div>
            </div>
            <!-- Collect the nav links, forms, and other content for toggling -->
            <div class="collapse navbar-collapse col-xs-12" id="bs-example-navbar-collapse-1">
